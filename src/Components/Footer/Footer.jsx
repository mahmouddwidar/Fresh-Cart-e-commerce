		...
		<section className="bg-light">
			<footer className="container py-4">
				...
				>
					...
					/>
					<button type="submit" className="btn bg-main text-white ms-2 me-4">
						Share App Link
					</button>
				</form>
				...
				<div
					className={`d-flex justify-content-between align-items-center ${Style["wrap-mob"]}`}
				>
					...
					<div className={`d-flex justify-content-between align-items-center ${Style['wrap-mob']}`}>
